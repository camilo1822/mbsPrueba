 ...
 */
@Entity
@Table(name = ConstantJPA.COMMON_STRING_ENTITY_CLIENTE, schema = ConstantJPA.COMMON_STRING_SHBANCA_DIGITAL)
@NamedQueries({
...
public class Cliente implements Serializable {
    ...
    private BigDecimal correoActivo;
    ...
    // bi-directional many-to-one association to TarjetaVirtual
    @OneToMany(mappedBy = "cliente")
    private List<TarjetaVirtual> tarjetaVirtuals;
    ...
    public BigDecimal getCorreoActivo() {
        return this.correoActivo;
    }

    public void setCorreoActivo(BigDecimal correoActivo) {
    ...
    public List<TarjetaVirtual> getTarjetaVirtuals() {
        return this.tarjetaVirtuals;
    }

    public void setTarjetaVirtuals(List<TarjetaVirtual> tarjetaVirtuals) {
        this.tarjetaVirtuals = tarjetaVirtuals;
    }

    public TarjetaVirtual addTarjetaVirtual(TarjetaVirtual tarjetaVirtual) {
        getTarjetaVirtuals().add(tarjetaVirtual);
        tarjetaVirtual.setCliente(this);

        return tarjetaVirtual;
    }

    public TarjetaVirtual removeTarjetaVirtual(TarjetaVirtual tarjetaVirtual) {
        getTarjetaVirtuals().remove(tarjetaVirtual);
        tarjetaVirtual.setCliente(null);
