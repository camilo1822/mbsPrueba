 ...
 * generated in the pruebas.seiya package. 
...
public class ObjectFactory {
    ...
    private final static QName _PruebaRS_QNAME = new QName("http://nequi.co/message/integration/services/mbs/prueba", "pruebaRS");
    ...
    private final static QName _PruebaRQ_QNAME = new QName("http://nequi.co/message/integration/services/mbs/prueba", "pruebaRQ");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: pruebas.seiya
     * 
     */
    ...
    /**
     * Create an instance of {@link PruebaRQType }
     * 
     */
    public PruebaRQType createPruebaRQType() {
        return new PruebaRQType();
    }

    /**
     * Create an instance of {@link PruebaRSType }
     * 
     */
    public PruebaRSType createPruebaRSType() {
        return new PruebaRSType();
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link PruebaRSType }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://nequi.co/message/integration/services/mbs/prueba", name = "pruebaRS")
    public JAXBElement<PruebaRSType> createPruebaRS(PruebaRSType value) {
        return new JAXBElement<PruebaRSType>(_PruebaRS_QNAME, PruebaRSType.class, null, value);
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link PruebaRQType }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://nequi.co/message/integration/services/mbs/prueba", name = "pruebaRQ")
    public JAXBElement<PruebaRQType> createPruebaRQ(PruebaRQType value) {
        return new JAXBElement<PruebaRQType>(_PruebaRQ_QNAME, PruebaRQType.class, null, value);
    }
